...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'listar') {
        ...
        $sql = "BEGIN MVCD_REPORTE_PAGO_PROVEEDOR(:p_cursor); END;";
        ...
        echo "<tr><th>DINERO TOTAL SALIDA</th></tr>";
...
<head>
    ...
    <title>REPORTE DE PAGOS A LOS PROVEEDORES</title>
    <link rel="stylesheet" href="styles.css">
</head>
<body>
    <h1>REPORTE DE PAGOS A LOS PROVEEDORES</h1>
